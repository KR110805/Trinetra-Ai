    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <Card className="border border-white/5 bg-[#09090B] rounded-lg">
        <CardHeader className="flex flex-row items-center justify-between pb-2">
          <CardTitle className="text-sm font-medium text-white">Global API Latency</CardTitle>
      ...
      <Card className="border border-white/5 bg-[#09090B] rounded-lg">
        <CardHeader className="flex flex-row items-center justify-between pb-2">
          <CardTitle className="text-sm font-medium text-white">Request Traffic &amp; Errors</CardTitle>
